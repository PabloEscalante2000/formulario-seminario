...
<div class="flex items-center justify-center min-h-screen px-4 py-12">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h1 class="text-2xl font-bold text-brand-black mb-2">Invitación no válida</h1>
            <p class="text-neutral-500">Este enlace de invitación no es válido o ya fue utilizado.</p>
        </div>
    </div>
</div>
@endsection
